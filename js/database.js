...
window.courses = [
    ...
    { name: "Sistemas Digitais", credits: 5, semester: 2, requirements: [2]},
    { name: "Cálculo II", credits: 4, semester: 2, requirements: [3]},
    { name: "Física II", credits: 4, semester: 2, requirements: [3, 4]},
    { name: "Física Experimental II", credits: 1, semester: 2, requirements: [4, 5]},
    { name: "Atividades Acad. Opt. Humanas", credits: 2, semester: 2},
    { name: "Algoritmos e Estrut. de Dados", credits: 5, semester: 3, requirements: [0]},
    { name: "Teoria da Computação", credits: 4, semester: 3},
    { name: "Arquitetura de Computadores", credits: 5, semester: 3},
    { name: "Cálculo III", credits: 4, semester: 3, requirements: [9]},
    { name: "Física III", credits: 4, semester: 3, requirements: [4, 9]},
    { name: "Física Experimental III", credits: 1, semester: 3, requirements: [11]},
    ...
    { name: "Física IV", credits: 4, semester: 4, requirements: [16, 17]},
    { name: "Física Experimental IV", credits: 1, semester: 4, requirements: [18]},
